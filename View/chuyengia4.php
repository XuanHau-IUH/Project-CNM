      ...
      <div class="col-md-8 offset-md-2">
        <div class="teacher-info text-center">
          <div class="teacher-photo">
            <img class="teacher-photo" src="img/team-4.jpg" alt="" width="300px" height="300px">
          </div>

          <div class="teacher-details">
            <strong>Họ và tên:</strong> Trần Văn Tuấn
          </div>
          <div class="teacher-details">
            <strong>Ngày sinh:</strong> 25/07/1985
          </div>
          <p>Xin chào, tôi là Trần Văn Tuấn, một giáo viên dành trọn tâm huyết cho việc giảng dạy học sinh với nhu cầu đặc biệt. 
            Tôi đã làm việc tại trường cấp 2 tư thục dành cho học sinh tự kỷ, nơi tôi đã trải qua những kinh nghiệm 
            xuất sắc trong việc áp dụng các phương pháp giảng dạy phù hợp cho mỗi cá nhân để thúc đẩy tiến bộ học tập và phát triển xã hội. 
            Tôi luôn tin rằng mỗi học sinh đều có tiềm năng đáng kinh ngạc và tôi cam kết hỗ trợ họ trên con đường thành công.</p>
          <!-- Form câu hỏi -->
