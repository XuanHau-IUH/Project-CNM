...
<div class="container-fluid bg-primary mb-5">
    <div class="d-flex flex-column align-items-center justify-content-center" style="min-height: 400px">
        <h3 class="display-3 font-weight-bold text-white">Tư vấn trực tiếp với giáo viên</h3>
    </div>
</div>
<!-- Header End -->
<!-- Blog Start -->
            ...
            <div class="col-lg-4 mb-4">
                <div class="card border-0 shadow-sm mb-2">
                    ...
                    <div class="card-body bg-light text-center p-4">
                        ...
                        <a href="index.php?chuyengia1" class="btn btn-primary px-4 mx-auto my-2">Chọn</a>
                    </div>
                </div>
            </div>
            <div class="col-lg-4 mb-4">
                <div class="card border-0 shadow-sm mb-2">
                    ...
                    <div class="card-body bg-light text-center p-4">
                        ...
                        <a href="index.php?chuyengia2" class="btn btn-primary px-4 mx-auto my-2">Chọn</a>
                    </div>
                </div>
            </div>
            <div class="col-lg-4 mb-4">
                <div class="card border-0 shadow-sm mb-2">
                    ...
                    <div class="card-body bg-light text-center p-4">
                        ...
                        <a href="index.php?chuyengia3" class="btn btn-primary px-4 mx-auto my-2">Chọn</a>
                    </div>
                </div>
            </div>
            <div class="col-lg-4 mb-4">
                <div class="card border-0 shadow-sm mb-2">
                    ...
                    <div class="card-body bg-light text-center p-4">
                        ...
                        <a href="index.php?chuyengia4" class="btn btn-primary px-4 mx-auto my-2">Chọn</a>
                    </div>
                </div>
            </div>
            <div class="col-lg-4 mb-4">
                <div class="card border-0 shadow-sm mb-2">
                    ...
                    <div class="card-body bg-light text-center p-4">
                        ...
                        <a href="index.php?chuyengia5" class="btn btn-primary px-4 mx-auto my-2">Chọn</a>
                    </div>
                </div>
            </div>
            <div class="col-lg-4 mb-4">
                <div class="card border-0 shadow-sm mb-2">
                    ...
                    <div class="card-body bg-light text-center p-4">
                        ...
                        <a href="index.php?chuyengia6" class="btn btn-primary px-4 mx-auto my-2">Chọn</a>
                    </div>
                </div>
            </div>
