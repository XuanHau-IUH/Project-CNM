              ...
              <form action="#" method="post" enctype="multipart/form-data">
                <div class="row">
                  <div class="col">
                    ...
                    <input type="text" class="form-control" id="manvpp" placeholder="Enter Mã nhân viên phân phối" name="manvpp" required=""></br>
                    <td>Tên nhân viên phân phối</td>
                    <input type="text" class="form-control" id="tennvpp" placeholder="Enter Tên nhân viên phân phối" name="tennvpp" required=""></br>
                    <td>Số điện thoại</td>
                    <input type="text" class="form-control" id="Sodienthoai" placeholder="Enter Số điện thoại nhân viên phân phối" name="sdt" required=""></br>
                    <span id="Sodienthoai" style="color:red;"></span></br>
                    <td>Địa chỉ</td>
                    <input type="text" class="form-control" id="diachi" placeholder="Enter địa chỉ nhân viên phân phối" name="diachi" ></br>
                    <td>Ngày sinh</td>
                    <input type="date" class="form-control" id="ngaysinh" placeholder="Enter Ngày sinh" name="ngaysinh" required=""></br>
...
<?php
  ...
  if (isset($_REQUEST["submit"])){
    ...
    $nvpp= new cNVPP();
    if ($username =="") {
      $insert=$nvpp-> add_nhanvienphanphoi($MaNVPP, $TenNVPP, $SDT, $DiaChi, $NgaySinh, $Email,$GioiTinh,$MaXa,$username);
      if ($insert ==1){
          echo "<script>alert('Thêm thành công');</script>";
