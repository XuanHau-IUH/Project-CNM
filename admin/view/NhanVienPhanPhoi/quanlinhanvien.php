	                    ...
	                    if($table){
		                    if(mysqli_num_rows($table) > 0){
			                    while($row = mysqli_fetch_assoc($table)) {
                                    echo "<tr>";
                                    echo "<td style='text-align:center'>".$row['MaNVPP']."</td>";
                                    echo "<td style='text-align:center'>".$row['TenNVPP']."</td>";
                                    ...
                                    if ($row['HinhAnh']== NULL) {
                                      ...
                                      echo "<td style='text-align:center'><img src='../assets/uploads/avatar/".$row['HinhAnh']."' alt='' height='100px' width='150px'></td>";
                                    }
                                    ...
                                    echo "<td style='text-align:center'><a href='?updatenvpp&&MaNVPP=".$row['MaNVPP']."'><i class='fa fa-pen' aria-hidden='true'></i></a> | <a href='?delnvpp&&MaNVPP=".$row['MaNVPP']."&&username=".$row['username']."' onclick='return confirm_delete();'><i class='fa fa-trash' aria-hidden='true'></i></a></td>";
                                    echo "</tr>";
			                    }
		                    }
	                    }
