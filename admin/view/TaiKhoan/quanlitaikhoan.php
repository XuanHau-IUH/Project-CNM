	                    ...
	                    if($table){
		                    if(mysqli_num_rows($table) > 0){
			                    while($row = mysqli_fetch_assoc($table)) {
                                    ...
                                    echo "<td>".$row['Role']."</td>";
                                    echo "<td><a href='?updatetk&&username=".$row['username']."&&Role=".$row['Role']."'><i class='fa fa-pen' aria-hidden='true'></i></a> | <a href='?deletetk&&username=".$row['username']."'><i class='fa fa-trash' aria-hidden='true'></i></a></td>";
                                    echo "</tr>";
			                    }
		                    }
	                    }
